...
const sendEmail = (e) => {
    ...
    if (window.emailjs && typeof window.emailjs.sendForm === 'function') {
        ...
        emailjs.sendForm('service_jnoj6oi', 'template_t16ggp8', '#contact-form', 'zD5W8EfjD7J9oOAhM')
            .then(() => {
                // Show sent message
        ...
        // Handle the case when the required functionality is not available
        contactMessage.textContent = 'Email service not available. Please try again later.';
    }
};
